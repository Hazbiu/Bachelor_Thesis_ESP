...
MAIN_DIR="${PROJECT_DIR}/src_p4/main"
...
echo
echo "============================================================"
echo " ESP32-P4 src_p4/main SOURCE EXPORTER"
echo "============================================================"
echo
echo "Source:"
echo "  ${MAIN_DIR}"
...
###############################################################################
# FIND FILES ONLY INSIDE src_p4/main
###############################################################################

declare -a FILES=()

echo "Scanning src_p4/main recursively..."
...
while IFS= read -r -d '' file; do
    ...
    find "${MAIN_DIR}" \
        -type f \
        ! -path "${MAIN_DIR}/ui/assets/launcher_heading.c" \
        ! -path "${MAIN_DIR}/ui/assets/university_logo.c" \
        \( \
            -name "*.c" \
            -o -name "*.h" \
            -o -name "*.cpp" \
