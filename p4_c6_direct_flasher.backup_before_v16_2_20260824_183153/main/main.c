...
#define BACKUP_PATH            "/sdcard/c6_factory_full_flash.bin"
#define BACKUP_OK_PATH         "/sdcard/C6_BACKUP_OK.txt"
#define SLEEP_FLASHED_PATH     "/sdcard/C6_SLEEP_FLASHED.txt"
#define RESTORE_REQUEST_PATH   "/sdcard/RESTORE_C6_FACTORY.txt"
#define RESTORED_PATH          "/sdcard/C6_FACTORY_RESTORED.txt"
