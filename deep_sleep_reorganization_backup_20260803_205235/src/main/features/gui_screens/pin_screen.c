...
static void refresh_pin_dots(uint32_t active_color)
{
    for (size_t i = 0; i < PIN_LENGTH; i++) {
        ...
        lv_obj_set_style_bg_color(
            s_pin_dots[i],
            lv_color_hex(filled ? active_color : 0x26364D),
            0);
        lv_obj_set_style_border_color(
            s_pin_dots[i],
            lv_color_hex(filled ? active_color : 0x4A5D77),
            0);
    }
}
...
static void submit_pin(void)
{
    ...
    if (strcmp(s_entered_pin, CORRECT_PIN) != 0) {
        set_status("Incorrect PIN. Please try again.", 0xFF7A90);
        refresh_pin_dots(0xFF5D73);
        memset(s_entered_pin, 0, sizeof(s_entered_pin));
        s_entered_length = 0;
        return;
    }
    ...
    set_status("Access granted. Returning to camera...", 0x69E6A6);
    refresh_pin_dots(0x3DDC97);
...
static void key_pressed_event_cb(lv_event_t *event)
{
    ...
    if (strcmp(key, "Clear") == 0) {
        reset_entry();
        set_status("Enter your four-digit access PIN", 0x9FB0C8);
        return;
    }
...
static lv_obj_t *create_key(lv_obj_t *parent, const char *text, bool secondary)
{
    lv_obj_t *button = lv_button_create(parent);
    lv_obj_set_size(button, LV_PCT(30), 58);
    lv_obj_remove_flag(button, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_radius(button, 16, 0);
    lv_obj_set_style_bg_color(
        button,
        lv_color_hex(secondary ? 0x111C2D : 0x19283E),
        0);
    lv_obj_set_style_bg_color(button, lv_color_hex(0x315FCE), LV_STATE_PRESSED);
    lv_obj_set_style_bg_color(button, lv_color_hex(0x273246), LV_STATE_DISABLED);
    lv_obj_set_style_border_color(button, lv_color_hex(0x324762), 0);
    lv_obj_set_style_border_width(button, 1, 0);
    lv_obj_set_style_shadow_color(button, lv_color_hex(0x020713), 0);
    ...
    lv_obj_set_style_text_color(
        label,
        lv_color_hex(secondary ? 0x9FB0C8 : 0xF8FAFF),
        0);
    lv_obj_center(label);
    ...
    void *user_data)
{
    ...
    lv_obj_set_style_bg_color(screen, lv_color_hex(0x060B16), 0);
    lv_obj_set_style_bg_grad_color(screen, lv_color_hex(0x101D33), 0);
    ...
    lv_obj_set_style_radius(shell, 30, 0);
    lv_obj_set_style_bg_color(shell, lv_color_hex(0x0D1728), 0);
    lv_obj_set_style_bg_opa(shell, LV_OPA_90, 0);
    lv_obj_set_style_border_color(shell, lv_color_hex(0x263A56), 0);
    lv_obj_set_style_border_width(shell, 1, 0);
    lv_obj_set_style_shadow_color(shell, lv_color_hex(0x000000), 0);
    lv_obj_set_style_shadow_width(shell, 34, 0);
    ...
    lv_obj_set_size(verified_badge, 168, 40);
    lv_obj_remove_flag(verified_badge, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_radius(verified_badge, 20, 0);
    lv_obj_set_style_bg_color(verified_badge, lv_color_hex(0x12382C), 0);
    lv_obj_set_style_bg_opa(verified_badge, LV_OPA_COVER, 0);
    lv_obj_set_style_border_color(verified_badge, lv_color_hex(0x2B8A68), 0);
    ...
    lv_obj_set_style_text_color(badge_label, lv_color_hex(0x69E6A6), 0);
    ...
    lv_obj_set_size(dot_row, LV_PCT(100), 62);
    lv_obj_remove_flag(dot_row, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_bg_color(dot_row, lv_color_hex(0x0A1322), 0);
    lv_obj_set_style_bg_opa(dot_row, LV_OPA_COVER, 0);
    lv_obj_set_style_border_color(dot_row, lv_color_hex(0x20344F), 0);
    lv_obj_set_style_border_width(dot_row, 1, 0);
    lv_obj_set_style_radius(dot_row, 18, 0);
    ...
    for (size_t i = 0; i < PIN_LENGTH; i++) {
        ...
        lv_obj_set_style_bg_color(s_pin_dots[i], lv_color_hex(0x26364D), 0);
        lv_obj_set_style_bg_opa(s_pin_dots[i], LV_OPA_COVER, 0);
        lv_obj_set_style_border_color(s_pin_dots[i], lv_color_hex(0x4A5D77), 0);
    ...
    lv_obj_set_style_bg_color(s_keypad, lv_color_hex(0x0A1322), 0);
    lv_obj_set_style_bg_opa(s_keypad, LV_OPA_COVER, 0);
    lv_obj_set_style_border_color(s_keypad, lv_color_hex(0x20344F), 0);
    lv_obj_set_style_border_width(s_keypad, 1, 0);
    lv_obj_set_style_radius(s_keypad, 24, 0);
