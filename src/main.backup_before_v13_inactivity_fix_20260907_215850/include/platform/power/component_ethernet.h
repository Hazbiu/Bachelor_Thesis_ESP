...
/**
 * Reversible Light-sleep path: keep the IP101GRI powered and enter its
 * documented WOL+ slave low-power state instead of asserting hardware RESET.
 *
 * The PHY remains out of reset (GPIO51 HIGH). WOL+ is entered manually over
 * Clause-22 MDC/MDIO and the sleeping PHY down-speeds to 10 Mbps. This keeps a
 * reduced-power network PHY state while the ESP32-P4 is in timer-sliced
 * Light-sleep.
 *
