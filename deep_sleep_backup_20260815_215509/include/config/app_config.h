...
/*
 * Power the SPI flash rail down during Deep-sleep. This is safe here because
 * the RTC timer is never used as a Deep-sleep wake source; GPIO3 is the only
 * wake source. Worth a few tens of microamps.
 */
