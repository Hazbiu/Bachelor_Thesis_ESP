#!/usr/bin/env python3
"""
v5: Quantize existing FLOAT32 TFLite FlatBuffers directly to full INT8.
...
v3 added support for this project's 320x240 raw RGB888 enrollment files.\n\nv4 removed calibration-only unreferenced FLOAT32 tensors before strict validation.\n\nv5 fixes NumPy-array FlatBuffer fields by using explicit None checks and adds\nreference diagnostics for any FLOAT32 tensors that truly remain executable.\n\nThis script first compacts/remaps the OperatorCode table so only codes actually
