...
SCRIPT="$ROOT/tools/quantize_existing_tflite_to_int8_v4.py"
...
echo "============================================================"
echo " TFLM INT8 / ESP-NN model conversion v4"
echo "============================================================"
...
echo
echo "v2 fix: remove stale UNUSED OperatorCode records before"
