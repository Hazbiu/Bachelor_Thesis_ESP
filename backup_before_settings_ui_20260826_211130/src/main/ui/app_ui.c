...
static void create_ready_pill(lv_obj_t *parent, bool dark_mode)
{
    ...
    lv_obj_set_style_bg_color(
        pill,
        lv_color_hex(dark_mode ? 0x153A2A : 0xDCFCE7),
        0);
    ...
    lv_obj_set_style_text_color(
        label,
        lv_color_hex(dark_mode ? 0x86EFAC : 0x15803D),
        0);
    lv_obj_center(label);
}
    ...
    void *user_data)
{
    ...
    lv_obj_set_style_text_color(
        s_status_label,
        lv_color_hex(dark ? 0x86EFAC : 0x15803D),
        0);
