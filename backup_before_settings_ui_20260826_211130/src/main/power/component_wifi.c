...
esp_err_t component_wifi_disable_for_deep_sleep(void)
{
     ...
     *
     * The settings policy may already have disabled the C6, while the ordered
     * sleep sequence calls this function again at STEP 6. Reprogramming the
     * pad on every call guarantees that STEP 6 really does work instead of
     * merely reporting success from a stale software flag.
     */
