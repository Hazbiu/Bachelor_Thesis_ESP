...
/**
 * Put the already-STREAMOFF OV5647 MIPI interface into a reversible
 * low-power state for Light-sleep.
 */
esp_err_t app_video_prepare_sensor_for_light_sleep(void);

/**
 * Restore the OV5647 MIPI registers saved before Light-sleep.
 * Call this before app_video_stream_task_restart().
 */
